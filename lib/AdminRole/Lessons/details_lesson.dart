...
class DetailsLessonTeacher extends StatefulWidget {
  final Lessons? lessons;

  DetailsLessonTeacher(this.lessons);

  @override
  _DetailsLessonTeacherState createState() => _DetailsLessonTeacherState();
}

class _DetailsLessonTeacherState extends State<DetailsLessonTeacher> {
  ...
  Widget build(BuildContext context1) {
    return BlocProvider(create: (BuildContext context)=>LessonsCubit(),
        ...
        return Scaffold(
          appBar: AppBar(
            ...
            actions: [
              IconButton(
                onPressed: () {
                  _showDeleteConfirmationDialog(context1);
                },
                ...
                Padding(
                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text(
                          'Course:${widget.lessons!.courseTitle}',
                          style: TextStyle(
                            fontSize: 24,
                        ...
                        SizedBox(height: 8),
                        Text(
                          'Title: ${widget.lessons!.lessonTitle}',
                          style: TextStyle(
                            fontSize: 24,
                            fontWeight: FontWeight.bold,
                            color: Colors.deepPurple,
